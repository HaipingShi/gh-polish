...
| src/repositoryReadyAgentProtocol.ts | A3 agent-facing M1 protocol | yes | keep prepare/review/execute effects explicit and report credential-free achieved separately from live GitHub deferred |
...
| test/t020.repositoryReadyAgentProtocol.test.ts | A3 T-020 verification asset | yes | prove protocol phases, exact review binding, fail-before-adapter behavior, and truthful M1 achieved/deferred reporting |
