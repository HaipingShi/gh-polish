...
- verify TR-20260713-035751-t023p has no harness_result
...
- Task: none
- Reason: Multiple active tasks make Drive ownership ambiguous: T-022, T-023.
- Next action: Keep exactly one task active or record an explicit task-selection decision before continuing.
...
- Run `/coderail:done-gate` and fix verification gaps before marking done.
